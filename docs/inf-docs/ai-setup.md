...
::: tip 提示
首先，你需要是 DHW 成员或 DHW Inf 玩家才能使用该系统登入服务器。若你是 DHW Inf 玩家，则在通过审核后你将获得一个一次性的邀请码，它将用于注册你的服务台账户。DHW Inf 审核QQ群：[873305382](https://jq.qq.com/?\_wv=1027\&k=CLcpAiWK)。若你是 DHW 成员，请直接与管理员联系来获取邀请码。
:::
