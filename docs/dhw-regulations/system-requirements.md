...
- 操作系统
    ...
    - 开发者在最近的6个月内提供了安全性更新
    - **建议**使用在附录的[操作系统列表](system-requirements.md#操作系统列表)列出的操作系统
- 浏览器
    - 在附录的[浏览器列表](system-requirements.md#浏览器列表)中的浏览器
    - 使用在一年内发布的版本
- 其他应用程序
...
- 操作系统
    ...
    - 使用最近发布的两个大版本
- 浏览器
    - 只能使用在附录的[浏览器**列表A或列表B**](system-requirements.md#浏览器列表)中的浏览器
- 其他应用程序
